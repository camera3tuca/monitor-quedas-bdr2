...
# Importar yahooquery para dados fundamentalistas (opcional - usa yfinance como fallback)
try:
    from yahooquery import Ticker as YQTicker
    YAHOOQUERY_DISPONIVEL = True
except ImportError:
    YAHOOQUERY_DISPONIVEL = False
...
# API Keys para dados fundamentalistas
BRAPI_TOKEN = "iExnKM1xcbQcYL3cNPhPQ3"
ALPHA_VANTAGE_KEY = "demo"  # Chave demo - pode usar até 5 requisições/min

# =============================================================================
# MAPEAMENTO BDR → TICKER US PARA DADOS FUNDAMENTALISTAS
# Mapeamento completo e corrigido - versão 2026
# =============================================================================
TICKER_MAP = {
    # As 7 Magníficas + Big Tech
    'AMZO34': 'AMZN',   # Amazon
    'GOGL34': 'GOOGL',  # Alphabet Class A
    'GOGL35': 'GOOG',   # Alphabet Class C
    'FBOK34': 'META',   # Meta (Facebook)
    'M1TA34': 'META',   # Meta alternativo
    ...
    # Fintech Brasileiro
    'ROXO34': 'NU',     # Nubank
    'PAGS34': 'PAGS',   # PagSeguro
    'STNE34': 'STNE',   # StoneCo
    'INBR32': 'INTR',   # Inter & Co
    'XPBR31': 'XP',     # XP Inc
    
    # Pagamentos
    'V1SA34': 'V',      # Visa
    'VISA34': 'V',      # Visa alternativo
    'MSCD34': 'MA',     # Mastercard
    'PYPL34': 'PYPL',   # PayPal
    
    # Bancos & Financeiro
    'JPMC34': 'JPM',    # JPMorgan Chase
    'BOAC34': 'BAC',    # Bank of America
    'GSGI34': 'GS',     # Goldman Sachs
    'MSBR34': 'MS',     # Morgan Stanley
    'CTGP34': 'C',      # Citigroup
    'CAON34': 'COF',    # Capital One
    'BONY34': 'BK',     # Bank of New York Mellon
    'BCSA34': 'SAN',    # Banco Santander
    
    # Tech & Software
    'ORCL34': 'ORCL',   # Oracle
    'ADBE34': 'ADBE',   # Adobe
    'CSCO34': 'CSCO',   # Cisco
    'CTSH34': 'CTSH',   # Cognizant
    'INTU34': 'INTC',   # Intuit
    'ACNB34': 'ACN',    # Accenture
    'UBER34': 'UBER',   # Uber
    'AIRB34': 'ABNB',   # Airbnb
    'SPOT34': 'SPOT',   # Spotify
    'DDOG34': 'DDOG',   # Datadog
    'SNOW34': 'SNOW',   # Snowflake
    
    # Semicondutores
    'ITLC34': 'INTC',   # Intel (corrigido!)
    'INTC34': 'INTC',   # Intel alternativo
    'A1MD34': 'AMD',    # AMD
    'QCOM34': 'QCOM',   # Qualcomm
    'AVGO34': 'AVGO',   # Broadcom
    'ASML34': 'ASML',   # ASML
    'MUTC34': 'MU',     # Micron
    'TXIN34': 'TXN',    # Texas Instruments
    
    # E-commerce & Retail  
    'MELI34': 'MELI',   # MercadoLibre
    'SHOP34': 'SHOP',   # Shopify
    'EBAY34': 'EBAY',   # eBay
    'BKNG34': 'BKNG',   # Booking
    'COWC34': 'COST',   # Costco
    'HOME34': 'HD',     # Home Depot
    'LOWC34': 'LOW',    # Lowe's
    'WALM34': 'WMT',    # Walmart
    
    # Entretenimento & Mídia
    'DISB34': 'DIS',    # Disney
    'CMCS34': 'CMCSA',  # Comcast
    'PARA34': 'PARA',   # Paramount
    
    # Farmacêuticas & Saúde
    'PFIZ34': 'PFE',    # Pfizer
    'MRCK34': 'MRK',    # Merck
    'ABBV34': 'ABBV',   # AbbVie
    'LILY34': 'LLY',    # Eli Lilly
    'JNJB34': 'JNJ',    # Johnson & Johnson
    'BMYB34': 'BMY',    # Bristol-Myers Squibb
    'GILD34': 'GILD',   # Gilead
    'A1ZN34': 'AZN',    # AstraZeneca
    'UNIH34': 'UNH',    # UnitedHealth
    'C1IC34': 'CI',     # Cigna
    'CVSH34': 'CVS',    # CVS Health
    'H1UM34': 'HUM',    # Humana
    
    # Energia
    'EXXO34': 'XOM',    # Exxon Mobil
    'CHVX34': 'CVX',    # Chevron
    'COPH34': 'COP',    # ConocoPhillips
    'SLBR34': 'SLB',    # Schlumberger
    'HALI34': 'HAL',    # Halliburton
    
    # Industrial & Aeroespacial
    'BOEI34': 'BA',     # Boeing
    'CATP34': 'CAT',    # Caterpillar
    'GEOO34': 'GE',     # GE Aerospace
    'HOND34': 'HMC',    # Honda
    'FDMO34': 'F',      # Ford
    'GMCO34': 'GM',     # General Motors
    
    # Telecom
    'ATTB34': 'T',      # AT&T
    'VERI34': 'VZ',     # Verizon
    'TMUS34': 'TMUS',   # T-Mobile
    
    # Consumo
    'COCA34': 'KO',     # Coca-Cola
    'PEPB34': 'PEP',    # PepsiCo
    'MDLZ34': 'MDLZ',   # Mondelez
    'PMCO34': 'PM',     # Philip Morris
    'MOOO34': 'MO',     # Altria
    'NIKE34': 'NKE',    # Nike
    'SBUB34': 'SBUX',   # Starbucks
    'MCDC34': 'MCD',    # McDonald's
    
    # Chinesas
    'BABA34': 'BABA',   # Alibaba
    'JDCO34': 'JD',     # JD.com
    'BIDU34': 'BIDU',   # Baidu
    'TCOM34': 'TCOM',   # Trip.com
    'N1IO34': 'NIO',    # NIO
    'P1DD34': 'PDD',    # PDD Holdings
    'B1IL34': 'BILI',   # Bilibili
    
    # Outros importantes
    'BERK34': 'BRK-B',  # Berkshire Hathaway
    'BLAK34': 'BLK',    # BlackRock
}

def mapear_ticker_us(ticker_bdr):
    """
    Mapeia BDR para ticker US com lógica melhorada
    1. Verifica dicionário manual (mais confiável)
    2. Fallback inteligente: remove sufixo numérico
    """
    # Primeiro: tentar mapeamento manual
    if ticker_bdr in TICKER_MAP:
        return TICKER_MAP[ticker_bdr]
    
    # Fallback: remover sufixo numérico (funciona para ~60% dos casos)
    # Ex: AAPL34 → AAPL, MSFT34 → MSFT
    ticker_base = ticker_bdr.rstrip('0123456789')
    
    # Casos especiais do fallback
    if ticker_base.endswith('B'):  # Ex: COCAB34 → COCA
        ticker_base = ticker_base[:-1]
...
def buscar_fundamentalista_individual(ticker_bdr):
    """
    Busca dados fundamentalistas com fallback automático
    1. Tenta YahooQuery (melhor, se disponível)
    2. Fallback automático para yfinance (sempre disponível)
    """
    ticker_us = mapear_ticker_us(ticker_bdr)
    
    # TENTATIVA 1: YahooQuery (se disponível)
    if YAHOOQUERY_DISPONIVEL:
        try:
            yq = YQTicker(ticker_us)
            summary = yq.summary_detail.get(ticker_us, {})
            profile = yq.asset_profile.get(ticker_us, {})
            financials = yq.financial_data.get(ticker_us, {})
            
            if summary and not isinstance(summary, str):
                dados = {
                    'marketCap': summary.get('marketCap') or financials.get('marketCap'),
                    'trailingPE': summary.get('trailingPE'),
                    'forwardPE': summary.get('forwardPE'),
                    'dividendYield': summary.get('dividendYield') or summary.get('trailingAnnualDividendYield'),
                    'revenueGrowth': financials.get('revenueGrowth'),
                    'earningsGrowth': financials.get('earningsGrowth'),
                ...
                tem_dados = any([dados.get('marketCap'), dados.get('trailingPE'), dados.get('forwardPE')])
            ...
            pass  # Se YahooQuery falhar, tenta yfinance
    
    # TENTATIVA 2: yfinance (fallback sempre disponível)
    try:
        stock = yf.Ticker(ticker_us)
        
        # Tentar múltiplos métodos do yfinance
        info = None
        
        # Método 1: info padrão
        try:
            info = stock.info
        except Exception:
            pass
        
        # Método 2: get_info() (mais recente)
        ...
        if info and len(info) > 5:
            # Extrair com campos flexíveis
            dados = {
                'marketCap': (info.get('marketCap') or info.get('enterpriseValue')),
                'trailingPE': (info.get('trailingPE') or info.get('forwardPE')),
...
def extrair_dados_fundamentalistas(info, stock):
    """
    FUNÇÃO OBSOLETA - mantida apenas para compatibilidade
    Agora usamos YahooQuery diretamente
    """
    return None

@st.cache_data(ttl=3600)
def buscar_fundamentalistas_batch(tickers_bdr, max_workers=10):
    """
    Busca dados fundamentalistas em PARALELO (muito mais rápido)
    max_workers: número de threads simultâneas (padrão: 10)
    """
    resultados = {}
    total = len(tickers_bdr)
    ...
    progress_text.text(f"📊 Buscando {total} BDRs em paralelo...")
    ...
    with ThreadPoolExecutor(max_workers=max_workers) as executor:
        ...
        futures = {executor.submit(buscar_fundamentalista_individual, ticker): ticker 
                  for ticker in tickers_bdr}
        
        # Processar conforme completam
        for future in as_completed(futures):
            ticker_bdr, dados = future.result()
            resultados[ticker_bdr] = dados
            ...
            progress_text.text(f"📊 Progresso: {concluidos}/{total} ({sucessos} ✅)")
    ...
    # Estatísticas
    yahooquery_count = sum(1 for v in resultados.values() if v.get('fonte') == 'YahooQuery')
    yfinance_count = sum(1 for v in resultados.values() if v.get('fonte') == 'yFinance')
    
    if YAHOOQUERY_DISPONIVEL:
        st.success(f"""
        ✅ **Dados fundamentalistas obtidos:** {sucessos}/{total} BDRs
        - 📊 YahooQuery: {yahooquery_count}
        - 📈 yFinance: {yfinance_count}
        - ❌ Sem dados: {total - sucessos}
        """)
    else:
        st.info(f"""
        ℹ️ **Dados fundamentalistas (yFinance):** {sucessos}/{total} BDRs
        - 📈 yFinance: {yfinance_count}
        - ❌ Sem dados: {total - sucessos}
        
        💡 **Dica:** Instale YahooQuery para melhor cobertura:
        ```
...
def buscar_dados_fundamentalistas(ticker_bdr):
    """
    Busca dados fundamentalistas com fallback inteligente
    1. Tenta Yahoo Finance (empresa mãe) - dados completos
    2. Se falhar, tenta BRAPI (BDR na B3) - dados limitados
    """
    ticker_us = mapear_ticker_us(ticker_bdr)
    
    # TENTATIVA 1: Yahoo Finance (melhor fonte)
    try:
        stock = yf.Ticker(ticker_us)
        info = stock.info
        ...
        if info and 'symbol' in info:
            # Verificar se tem pelo menos algumas métricas fundamentalistas
            tem_dados = any([
                info.get('marketCap'),
                info.get('trailingPE'),
                info.get('forwardPE'),
            ...
            if tem_dados:
                score, detalhes = calcular_score_fundamentalista(info)
                
                return {
                    'fonte': 'Yahoo Finance (Empresa Mãe)',
                    'ticker_fonte': ticker_us,
                    'score': score,
                    'detalhes': detalhes,
    ...
    # TENTATIVA 2: BRAPI (dados limitados da B3)
    try:
        dados_brapi = buscar_dados_brapi(ticker_bdr)
        
        if dados_brapi and dados_brapi.get('market_cap'):
            ...
            return {
                ...
                'sucesso': True,
                'limitado': True,  # Flag indicando dados limitados
            }
    except Exception:
        pass
...
def analisar_oportunidades(df_calc, mapa_nomes, dados_fundamentalistas=None):
    resultados = []
    tickers = df_calc.columns.get_level_values(1).unique()
    ...
    for ticker in tickers:
        try:
            ...
            # Buscar dados fundamentalistas se disponíveis
            fund_data = None
            fund_score = None
            if dados_fundamentalistas and ticker in dados_fundamentalistas:
                fund_data = dados_fundamentalistas[ticker]
                if fund_data.get('sucesso'):
                    fund_score = fund_data.get('score')
            ...
            resultados.append({
                ...
                'Fund_Score': fund_score,  # Score fundamentalista
                'Fund_Data': fund_data,     # Dados completos para o painel
            })
        except: continue
    return resultados
...
if st.button("🔄 Atualizar Análise", type="primary"):
    ...
    # Analisar oportunidades SEM dados fundamentalistas primeiro (rápido)
    with st.spinner("Analisando oportunidades técnicas..."):
        oportunidades = analisar_oportunidades(df_calc, NOMES_BDRS, None)
        
        if oportunidades:
            # Extrair apenas os tickers das oportunidades encontradas
            tickers_oportunidades = [opp['Ticker'] for opp in oportunidades]
            
            # Buscar fundamentalistas APENAS dessas BDRs (geralmente 10-30)
            st.markdown("### 📊 Carregando Dados Fundamentalistas")
            st.info(f"💡 Buscando dados de **{len(tickers_oportunidades)} BDRs** em oportunidade (não todas as 677)")
            
            dados_fundamentalistas = buscar_fundamentalistas_batch(tickers_oportunidades, max_workers=15)
            
            # Re-analisar COM dados fundamentalistas
            oportunidades = analisar_oportunidades(df_calc, NOMES_BDRS, dados_fundamentalistas)
    ...
    if not df_res.empty:
        ...
        evento = st.dataframe(
            ...
            .format({
                ...
                'Stoch': '{:.0f}',
                'Liquidez': '{:.0f}',
                'Fund_Score': lambda x: f'{x:.0f}%' if pd.notna(x) else '—'
            }),
            column_order=("Ticker", "Empresa", "Queda_Dia", "Preco", "Liquidez", "Fund_Score", "IS", "Volume", "Gap", "Potencial", "Score", "Sinais"),
            column_config={
                "Empresa": st.column_config.TextColumn("Empresa", width="medium"),
                "Queda_Dia": st.column_config.NumberColumn("📉 Queda", help="Queda percentual no dia"),
                "Preco": st.column_config.NumberColumn("💰 Preço", help="Preço atual em R$"),
                "Liquidez": st.column_config.NumberColumn("💧 Liq.", width="small",
                    help="Ranking de Liquidez 0-10 (🔴 baixa → 🟢 alta)"),
                "Fund_Score": st.column_config.TextColumn("📊 Fund", width="small",
                    help="Score Fundamentalista 0-100% | —= sem dados"),
        ...
        if evento.selection and evento.selection.rows:
            ...
            fund_data = row.get('Fund_Data')
            
            if fund_data and fund_data.get('sucesso'):
                # Verificar se teve sucesso
                if not fund_data.get('sucesso', True):
                    st.warning(f"⚠️ Não foi possível obter dados fundamentalistas para {ticker}")
                    ticker_us = fund_data.get('ticker_us', '')
                    st.info(f"""
                    💡 **Por que isso acontece?**
                    
                    - Ticker BDR: `{ticker}`
                    - Ticker US tentado: `{ticker_us}`
                    
                    **Tentativas realizadas:**
                    1. ❌ Yahoo Finance (empresa mãe) - Sem dados ou ticker inválido
                    2. ❌ BRAPI (BDR na B3) - Sem dados disponíveis
                    
                    **Possíveis causas:**
                    - BDR muito nova ou com baixíssimo volume
                    - Ticker não tem correspondente US direto
                    - Empresa privada ou delisted
                    - Dados ainda não disponíveis nas APIs públicas
                    
                    **💡 Dica:** Tente pesquisar manualmente o ticker US correto da empresa e me avise para adicionar ao mapeamento.
                    """)
                else:
                    ...
                    eh_limitado = fund_data.get('limitado', False)
                # Card com score em porcentagem
                score = fund_data['score']
                fonte = fund_data.get('fonte', 'Yahoo Finance')
                ticker_fonte = fund_data.get('ticker_fonte', ticker)
                ...
                st.info("📊 **Dados obtidos via YahooQuery** — API estável e confiável para dados fundamentalistas")
                ...
                ticker_us_tentado = mapear_ticker_us(ticker)
                
                st.info(f"""
                ℹ️ **Dados fundamentalistas não disponíveis para {ticker}**
                
                **Ticker US tentado:** `{ticker_us_tentado}`
                
                **Possíveis causas:**
                1. Ticker US incorreto no mapeamento
                2. Empresa muito pequena ou privada
                3. BDR recém-listada sem dados disponíveis
                4. Ticker delisted ou descontinuado
                
                💡 **Os dados técnicos estão completos e disponíveis acima.**
                
                ---
                
                **🔧 Quer ajudar a melhorar?**
                
                Se você sabe o ticker US correto para `{ticker}`, nos avise:
                - Pesquise no Google: "{row['Empresa']} ticker symbol NYSE NASDAQ"
                - O ticker correto pode ser adicionado ao mapeamento
                
                Exemplo: `{ticker}` → `????` (ticker US correto)
                """)
