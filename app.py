...
if 'oportunidades' in st.session_state and 'df_calc' in st.session_state:
    ...
    if not df_res.empty:
        ...
        evento = st.dataframe(
            ...
            column_order=("Ticker", "Empresa", "Liquidez_Cor", "Liquidez_Ranking", "Liquidez_Class", "Preco", "Queda_Dia", "IS", "Volume", "Gap", "Potencial", "Score", "Sinais"),
            column_config={
                "Empresa": st.column_config.TextColumn("Empresa", width="medium"),
                "Liquidez_Cor": st.column_config.TextColumn("💧", width="small", help="Indicador Visual de Liquidez"),
                "Liquidez_Ranking": st.column_config.NumberColumn("Rank", width="small", help="Ranking de Liquidez (0-10)"),
                "Liquidez_Class": st.column_config.TextColumn("Liquidez", width="small", help="Classificação de Liquidez"),
