...
def buscar_fundamentalista_individual(ticker_bdr):
    """
    Busca dados fundamentalistas apenas no Yahoo Finance
    Retorna (ticker, dados)
    """
    try:
...
def buscar_fundamentalistas_batch(tickers_bdr, max_workers=10):
    ...
    st.success(f"""
    ✅ **Dados fundamentalistas (Yahoo Finance):** {sucessos}/{total} BDRs
    - 📊 Dados completos: {yahoo_count}
