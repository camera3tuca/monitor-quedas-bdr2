...
def buscar_dados_fundamentalistas(ticker_bdr):
    """
    Busca dados fundamentalistas com fallback
    1. Tenta Yahoo Finance (empresa mãe)
    2. Se falhar, tenta BRAPI (BDR na B3)
    """
    ...
    try:
        ...
        if info and 'symbol' in info and info.get('marketCap'):
